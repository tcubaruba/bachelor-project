...
industry_bc <- c('Industry_1', 'Industry_2', 'Industry_3', 'Industry_4', 'Industry_5')
industry_wc <- c('Industry_6', 'Industry_7', 'Industry_8', 'Industry_9', 'Industry_10')
industry_nc <- c('Industry_11', 'Industry_12', 'Industry_13', 'Industry_14', 'Industry_15')

region_bc <- c('Region_1', 'Region_2', 'Region_3', 'Region_4', 'Region_5')
region_wc <- c('Region_6', 'Region_7', 'Region_8', 'Region_9', 'Region_10')
region_nc <- c('Region_11', 'Region_12', 'Region_13', 'Region_14', 'Region_15')
...
data_for_plot$Var2 <- as.Date(data_for_plot$Var2)
print(data_for_plot)
library(tidyverse)
ggplot(data_for_plot) + geom_area(mapping = aes(x = Var2, y = Freq, fill = Var1))
```
